...
def generate_main(args):
    ...
    if args.save_individual_scores:   #false
        print('save_ind')
    ...
    molecules = generator.optimise(objective=scoring_function,
                                   start_population=starting_population,   #none
                                   n_epochs=args.n_epochs,   #20
                                   mols_to_sample=args.mols_to_sample,   #1024
                                   keep_top=args.keep_top,  #512
                                   optimize_batch_size=args.optimize_batch_size,   #256
                                   optimize_n_epochs=args.optimize_n_epochs,   #2
                                   pretrain_n_epochs=args.pretrain_n_epochs,   #2
                                   ind_scorers=scorers,   #none
                                   save_payloads=args.save_payloads,   #False
                                   save_frequency=args.save_frequency   #5
                                   )
